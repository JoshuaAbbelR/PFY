...
export 'massage_model.dart';

class MassageWidget extends StatefulWidget {
  const MassageWidget({super.key});

  @override
  State<MassageWidget> createState() => _MassageWidgetState();
}

class _MassageWidgetState extends State<MassageWidget> {
  late MassageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MassageModel());
  }
